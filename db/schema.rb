...
ActiveRecord::Schema.define(version: 2022_05_12_030650) do
  ...
  create_table "destinations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchased_item_id"], name: "index_destinations_on_purchased_item_id"
  end
  ...
  add_foreign_key "destinations", "purchased_items"
